...
class SalesPropertyRegisterView2 extends StatefulWidget {
  const SalesPropertyRegisterView2({super.key});

  @override
  State<SalesPropertyRegisterView2> createState() =>
      _SalesPropertyRegisterViewState();
}

class _SalesPropertyRegisterViewState
    extends State<SalesPropertyRegisterView2> {
